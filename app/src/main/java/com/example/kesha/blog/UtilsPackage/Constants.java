...
public class Constants {
    ...
    public static final String consumerKey = "3l88rEX24pYc75EjPRfpGoQ9I1dYZAbuMa9F2e2s2PrL2UUVqH";
    //public static final String consumerSecret = "X3B5Pm1xuqqerpLdqXFeozYJZNVnkvNAzK43UmkXHHMerHBlt8";
    public static final String consumerSecret = "AKkQOEMvJPx2vqYTO6VofRE36t9Kj0yZ9xqXUVOs5f4is1oJUF";
